...
getdata();
  ...
  <div class="grid gap-8 items-center justify-center">
    <div class="relative group ">
      ...
      <img src= {`https://ipfs.io/ipfs/${metadata}/image`} alt="" className=' relative mt-[20%] md:mt-[10%] w-[100vmax] h-full md:w-full md:h-full bg-black rounded-lg leading-none flex items-center '/>
    </div>
  </div>
</div>
