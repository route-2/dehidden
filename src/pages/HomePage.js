...
getdata();
  ...
  <div class="relative w-screen h-screen">
    ...
    <div class="absolute md:left-[50%] left-[50%] top-[100%] md:top-[70%]  md:w-[60%] md:h-[30%] w-[60%] h-[40%] bg-gradient-to-r from-red-300 to-white rounded-tl-full rounded-tr-full mix-blend-lighten filter opacity-50 blur-[100px]  "></div>
