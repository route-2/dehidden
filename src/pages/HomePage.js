...
getdata();
  ...
  <div class="relative w-screen h-screen">
    ...
    <div class="absolute md:left-[50%] left-[20%] top-[100%] md:top-[70%]  md:w-[40%] md:h-[30%] w-[50%] h-[40%] bg-gradient-to-r from-red-300 to-white rounded-tl-full rounded-tr-full mix-blend-lighten filter opacity-50 blur-[100px]  "></div>
