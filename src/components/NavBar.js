    ...
    <>
      <header className="bg-none relative z-1 w-screen ">
        <div className="max-w-screen mx-auto flex items-center justify-between  ">
          <div className="w-25 pt-4 pl-4 ">
            <img
              src="https://svgshare.com/i/jBd.svg"
              className="w-full "
              title="Dehidden"
              alt="Dehidden"
            />
          ...
          <div class="mr-8 md:hidden mt-4 z-10">
            <div class="grid gap-8 items-start justify-center">
              <div class="relative group">
                ...
                <button
                  onClick={onClick}
                  className="relative text-white px-6 ml-2 py-2 bg-regal-red rounded-full leading-none flex items-center divide-x divide-gray-600"
                >
                  Share
                </button>
              </div>
          ...
          >
            <div className="mr-10 ml-10">
              <div className="container mt-4  bg-gray-200 rounded-full bg-opacity-20 backdrop-blur-xl  drop-shadow-lg justify-between  w-fit md:w-fit flex flex-row items-center  ">
                <textarea
                  className="w-fit h-6 pl-6 resize-none bg-transparent text-white rounded-full border-none md:mr-5 mr-4"
                  ...
                  <div class="grid gap-8 items-start justify-center">
                    <div class="relative group">
                      ...
                      <button
                        ...
                        className="relative text-white mt-2 mb-2   px-6 py-2 bg-regal-red rounded-full leading-none flex items-center divide-x divide-gray-600"
                      >
                        Copy
                      </button>
                    </div>
